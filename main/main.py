...
def extract_color_temp_map(image, min_temp, max_temp, x1=306, y1=36, x2=315, y2=211):
    ...
    # Sorting is optional since the interpolation already runs from max to min.
...
def estimate_temperature(image, color_temp_map, x_target, y_target):
    ...
    """
    # Get target pixel color (BGR) and convert to normalized RGB
...
def main():
    ...
    while True:
        ...
        # Calculate elapsed time and overlay on frame.
